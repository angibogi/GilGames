    ...
    return (
        ...
        <>
            ...
            <nav className="navbar">
                ...
                <Link to="/GilGames" className="logo"><img src={logo} alt=""/></Link>
                ...
                <ul className="nav-links">
                    ...
                    <div className="menu">
                        <Link to="/GilGames" style={{textDecoration: 'none'}} className="nav_item"> <span>Home Page</span> </Link>
                        ...
                        <a href="/game/login" style={{textDecoration: "none"}}><div onClick={e=>loginWithRedirect()} className="nav_item login"><span><BiUser size={30}/>{ isAuthenticated ? (
